Scriptname AFT:TweakScanCFoodScript extends Quest
...
FormList		Property TweakConstructed_Food		Auto Const
...
bool Function Trace(string asTextToPrint, int aiSeverity = 0) debugOnly
	string logName = "TweakScanCFoodScript"
...
Function ScanHelper()
	...
	ObjectReference[] results = center.FindAllReferencesOfType(TweakConstructed_Food, radius)			
