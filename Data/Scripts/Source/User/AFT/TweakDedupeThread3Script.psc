Scriptname AFT:TweakDedupeThread3Script extends Quest
...
bool Function Trace(string asTextToPrint, int aiSeverity = 0) debugOnly
	string logName = "TweakDedupeThread3Script"
...
Function Dedupe(Actor Receiver)
	...
	int i = 0
	bool keepgoing = true
	int numitems = TweakDedupe3Items.GetSize()
	while (i < numitems && keepgoing)
		pc.RemoveItem(TweakDedupe3Items.GetAt(i),1,true,filterContainer)
		i += 1
		if (0 == (i % 32))
	...
	pc.RemoveItem(TweakDedupe3Items,-1,true,dupContainer)
	...
	if	dupContainer
		...
		dupContainer.RemoveItem(TweakDedupe3Items,-1,true,Receiver)
		Utility.WaitMenuMode(0.1)
		int maxwait = 10
	...
	if	filterContainer
		...
		filterContainer.RemoveItem(TweakDedupe3Items,-1,true,pc)
